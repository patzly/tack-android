...
Java_xyz_zedler_patrick_audio_bridge_OboeNativeBridge_nativeCreate(
...
Java_xyz_zedler_patrick_audio_bridge_OboeNativeBridge_nativeDestroy(
...
Java_xyz_zedler_patrick_audio_bridge_OboeNativeBridge_nativeInit(
    JNIEnv *env, jobject jEngine, jlong handle) {
...
JNIEXPORT jboolean JNICALL
Java_xyz_zedler_patrick_audio_bridge_OboeNativeBridge_nativeStart(
    JNIEnv *env, jobject jEngine, jlong handle) {
  if (handle == 0) return JNI_FALSE;
...
JNIEXPORT jboolean JNICALL
Java_xyz_zedler_patrick_audio_bridge_OboeNativeBridge_nativeStop(
    JNIEnv *env, jobject jEngine, jlong handle) {
  if (handle == 0) return JNI_FALSE;
...
JNIEXPORT void JNICALL
Java_xyz_zedler_patrick_audio_bridge_OboeNativeBridge_nativeSetTickData(
...
JNIEXPORT void JNICALL
Java_xyz_zedler_patrick_audio_bridge_OboeNativeBridge_nativePlayTick(
    JNIEnv *env, jobject jEngine, jlong handle, jint tick_type) {
  if (handle == 0) return;
...
JNIEXPORT void JNICALL
Java_xyz_zedler_patrick_audio_bridge_OboeNativeBridge_nativeSetMasterVolume(
...
JNIEXPORT void JNICALL
Java_xyz_zedler_patrick_audio_bridge_OboeNativeBridge_nativeSetDuckingVolume(
    JNIEnv *env, jobject jEngine, jlong handle, jfloat volume) {
  if (handle == 0) return;
...
JNIEXPORT void JNICALL
Java_xyz_zedler_patrick_audio_bridge_OboeNativeBridge_nativeSetMuted(
