...
import xyz.zedler.patrick.tack.ui.component.TextIconButton
...
fun CenterPicker(
  ...
  val width = spToDp(spValue = if (isSmallScreen()) 64 else 72)
  val height = spToDp(spValue = if (isSmallScreen()) 104 else 140)
